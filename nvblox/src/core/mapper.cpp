...
RgbdMapper::RgbdMapper(float voxel_size_m, MemoryType memory_type)
   ...
   layers_.insert(std::type_index(typeid(ColorLayer)), 
       std::move(std::make_unique<ColorLayer>(sizeArgumentFromVoxelSize<ColorLayer>(voxel_size_m), memory_type)));
   layers_.insert(std::type_index(typeid(TsdfLayer)), 
       std::move(std::make_unique<TsdfLayer>(sizeArgumentFromVoxelSize<TsdfLayer>(voxel_size_m), memory_type)));
   layers_.insert(std::type_index(typeid(EsdfLayer)), 
       std::move(std::make_unique<EsdfLayer>(sizeArgumentFromVoxelSize<EsdfLayer>(voxel_size_m), memory_type)));
   layers_.insert(std::type_index(typeid(MeshLayer)), 
       std::move(std::make_unique<MeshLayer>(sizeArgumentFromVoxelSize<MeshLayer>(voxel_size_m), memory_type)));
}
